...
function PublicHeader({ user }: { user: ShellUser }) {
  ...
  const accountLabel =
    user?.role === "admin" ? "Admin" : user ? "Rescue Manager" : "Sign In";
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Add /adoptable, /urgent, and /resources only when those routes exist. */}
    ...
    <div style={{ minHeight: "100vh", background: COLORS.background }}>
      ...
      >
        <aside style={{ background: COLORS.navy, color: "#fff", padding: "24px 18px" }}>
          <a
            href="/"
            style={{ color: "#fff", textDecoration: "none", fontWeight: 800, fontSize: 18 }}
          >
            PACK OF FIVE
          </a>
          <div
          ...
          <nav aria-label="Rescue Manager navigation">
            ...
            {/* Add future sections only when their routes exist. */}
          </nav>
